...
public class Livro implements Serializable{
	...
	@Length(min=2, max=50, message="O campo TITULO deve ter entre 3 e 100 caracteres")
	private String titulo;
	@NotEmpty(message = "Campo NOME DO AUTOR é requerido")
	@Length(min=2, max=50, message="O campo NOME DO AUTOR deve ter entre 3 e 100 caracteres")
